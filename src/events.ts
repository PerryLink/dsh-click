 ...
 *   get no append — the tool results remain the reconstructable audit trail. On 0.1.2-alpha.3 the envelope field is retained for stored-log read compatibility only - its Session.append still cannot stamp the marker, so the gate behavior is unchanged.
 *
