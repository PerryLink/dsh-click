...
[![dshfind](https://dshfind.com/api/badge/PerryLink/dsh-click?metric=downloads&lang=zh)](https://dshfind.com/zh/plugins/PerryLink/dsh-click?ref=badge)
...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2`（GitHub tag，2026-09-11 已核验）。已于 2026-09-11 对照 dsh-v0.1.7-alpha.1 master checkout 核验（完整门禁链 + profile 安装冒烟）。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
