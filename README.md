...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.1` (GitHub tag, verified 2026-09-24). Verified 2026-09-11 against the dsh-v0.1.7-alpha.1 master checkout (full gate chain + profile install smoke). |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm test           # vitest: 79 tests, 13 files (helper smoke runs on Windows)
