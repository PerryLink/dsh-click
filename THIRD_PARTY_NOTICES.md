...
| `@deepseek-ai/dsh-*` peers | `>=0.1.0-rc.8 <0.2.0` | See packages | Official harness seams (`dsh-tools`, `dsh-session`, `dsh-subprocess`, `dsh-llm`, `dsh-attachment`, `dsh-agent`, `dsh-user-approval`) |
